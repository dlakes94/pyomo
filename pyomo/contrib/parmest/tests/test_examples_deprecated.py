...
class TestRooneyBieglerExamples(unittest.TestCase):
    ...
    def test_model(self):
        from pyomo.contrib.parmest.examples._deprecated.rooney_biegler import rooney_biegler

        rooney_biegler.main()

    def test_model_with_constraint(self):
        from pyomo.contrib.parmest.examples._deprecated.rooney_biegler import (
    ...
    def test_bootstrap_example(self):
        from pyomo.contrib.parmest.examples._deprecated.rooney_biegler import bootstrap_example
...
class TestReactionKineticsExamples(unittest.TestCase):
    ...
    def test_example(self):
        from pyomo.contrib.parmest.examples._deprecated.reaction_kinetics import (
...
class TestSemibatchExamples(unittest.TestCase):
    ...
    def test_model(self):
        from pyomo.contrib.parmest.examples._deprecated.semibatch import semibatch

        semibatch.main()

    def test_parameter_estimation_example(self):
        from pyomo.contrib.parmest.examples._deprecated.semibatch import (
            parameter_estimation_example,
        )
    ...
    def test_scenario_example(self):
        from pyomo.contrib.parmest.examples._deprecated.semibatch import scenario_example
...
class TestReactorDesignExamples(unittest.TestCase):
    ...
    def test_model(self):
        from pyomo.contrib.parmest.examples._deprecated.reactor_design import reactor_design

        reactor_design.main()

    def test_parameter_estimation_example(self):
        from pyomo.contrib.parmest.examples._deprecated.reactor_design import (
            parameter_estimation_example,
        )
    ...
    @unittest.skipUnless(seaborn_available, "test requires seaborn")
    def test_bootstrap_example(self):
        from pyomo.contrib.parmest.examples._deprecated.reactor_design import bootstrap_example
    ...
    def test_leaveNout_example(self):
        from pyomo.contrib.parmest.examples._deprecated.reactor_design import leaveNout_example
    ...
    def test_datarec_example(self):
        from pyomo.contrib.parmest.examples._deprecated.reactor_design import datarec_example
